...
#ifndef MM_XMMRPC_XMM7360_PROTOCOL_H
#define MM_XMMRPC_XMM7360_PROTOCOL_H
...
Xmm7360RpcResponse *xmm7360_parse_response             (GByteArray              *buf,
                                                        GError                 **error);

GByteArray *        xmm7360_command_to_byte_array      (Xmm7360RpcCallId         callid,
                                                        gboolean                 is_async,
                                                        GByteArray              *body);
...
#endif /* MM_XMMRPC_XMM7360_PROTOCOL_H */
