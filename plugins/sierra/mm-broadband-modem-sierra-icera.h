...
#define MM_BROADBAND_MODEM_SIERRA_ICERA_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass),  MM_TYPE_BROADBAND_MODEM_SIERRA_ICERA_AIRLINK, MMBroadbandModemSierraIceraClass))
#define MM_IS_BROADBAND_MODEM_SIERRA_ICERA(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), MM_TYPE_BROADBAND_MODEM_SIERRA_ICERA_AIRLINK))
#define MM_IS_BROADBAND_MODEM_SIERRA_ICERA_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass),  MM_TYPE_BROADBAND_MODEM_SIERRA_ICERA_AIRLINK))
#define MM_BROADBAND_MODEM_SIERRA_ICERA_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj),  MM_TYPE_BROADBAND_MODEM_SIERRA_ICERA_AIRLINK, MMBroadbandModemSierraIceraClass))
